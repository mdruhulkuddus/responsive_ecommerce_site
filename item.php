...
<div class="col-lg-9 well" style="background:#f4f4f4; text-align:center; overflow:hidden">
				 <style type="text/css">
				 	...
				 	<div class="col-lg-12" style="background:#0099FF; font-family:'Times New Roman', Times, serif; color:#FFFFFF"><h4><?php print $itemName ?></h2></div>
				 	
					
					<?php
					$select_pdt=mysql_query("select * from productinformation where Item_name='$itemName' ORDER BY RAND() limit 15");
